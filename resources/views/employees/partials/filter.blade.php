<div class="section">
    ...
    <div class="section-body">
        <form action="{{ route('users.list') }}" method="GET" class="row row-cols-md-auto g-3 align-items-end">
            <div class="col">
            ...
            <div class="col">
                <a href="{{ route('users.list') }}" class="btn-submit text-decoration-none" style="margin: 0; width: 100px;">
                    Clear
                </a>
            </div>
        </form>
