<div class="section">
    ...
    <div class="section-body">
        <form id="filterForm" class="row g-3 align-items-end" action="{{ route('assets.list') }}" method="GET">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="serial_number" class="form-control" value="{{ request('serial_number') }}">
            </div>
