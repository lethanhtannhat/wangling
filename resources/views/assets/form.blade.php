        ...
        <form method="POST" action="{{ $action }}">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="input-col"><input type="number" name="memory" min="0" step="0.01" value="{{ old('memory', $asset->memory) }}" required></td>
                    <td class="label-col">Storage (GB)</td>
                    <td class="input-col"><input type="number" name="storage" min="0" step="0.01" value="{{ old('storage', $asset->storage) }}" required></td>
                </tr>
                <tr>
